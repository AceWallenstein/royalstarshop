...
public class VipGoodsAdapter extends BaseAdapter<GoodsListsModel.DataBeanX.ListBean.DataBean, VipGoodsAdapter.VH> {

    public VipGoodsAdapter(Context mContext) {
        super(mContext);
    }
    ...
    public VH onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new VH(LayoutInflater.from(mContext).inflate(R.layout.item_goods_vip, parent, false));
    }
